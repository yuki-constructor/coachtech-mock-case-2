<?php $__env->startSection('title', '勤怠修正申請一覧（承認待ち）画面（従業員）'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/attendance/employee/attendance-request-list-pending.css')); ?>">
<?php $__env->stopPush(); ?>
        ...
        <div class="container">
            ...
            <div class="menu">
                <div class="menu__link">
                    ...
                    <a href="<?php echo e(route('employee.attendance.request.list.approved')); ?>" class="menu__link-right">承認済み</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.employee-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/attendance/employee/attendance-request-list-pending.blade.php ENDPATH**/ ?>