<?php $__env->startSection('title', '修正申請承認画面（管理者）'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/attendance/admin/attendance-request-show.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-wrap">
        <div class="container">
            ...
            <form
                action="<?php echo e(route('admin.attendance.request.acknowledge', ['attendanceRequestId' => $attendanceRequest->id])); ?>"
                method="POST">
                <?php echo csrf_field(); ?>
                ...
                <?php if($attendanceRequest->attendance_request_status_id === ($approvedStatusId ?? null)): ?>
...
<?php echo $__env->make('layouts.admin-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/attendance/admin/attendance-request-show.blade.php ENDPATH**/ ?>