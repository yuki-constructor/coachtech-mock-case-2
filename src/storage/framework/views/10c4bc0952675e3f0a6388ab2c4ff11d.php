...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/auth/employee/login.css')); ?>">
<?php $__env->stopPush(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-wrap">
        <div class="container">
            ...
            <form class="form" method="POST" action="<?php echo e(route('employee.authenticate')); ?>">
                <?php echo csrf_field(); ?>
            ...
            <p class="login-link">
                <a class="login-link__link-btn" href="<?php echo e(route('employee.register')); ?>">会員登録はこちら</a>
            </p>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/auth/employee/login.blade.php ENDPATH**/ ?>