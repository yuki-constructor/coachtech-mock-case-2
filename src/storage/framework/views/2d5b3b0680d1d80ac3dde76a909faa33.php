...
<head>
    ...
    <!-- 共通のCSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/employee-app.css')); ?>">
    <!-- ページごとのCSS -->
            ...
            <div class="header-right">
                <nav class="nav">
                    <ul class="nav__ul">
                        ...
                        <li>
                            <a class="nav__application" href="<?php echo e(route('employee.attendance.request.list.pending')); ?>"
                                method="GET">
                                申請
                            </a>
                        </li>
...
<?php /**PATH /var/www/resources/views/layouts/employee-app.blade.php ENDPATH**/ ?>